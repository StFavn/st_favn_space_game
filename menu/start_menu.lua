...
local function load_start_menu()
  ...
  start_menu.settings = {text = "Настройки",  x = 100, y = 200, w = 200, h = 25, m_state = 0, callback = callback_settings}
  start_menu.exit =     {text = "Выход",      x = 100, y = 250, w = 200, h = 25, m_state = 0, callback = callback_exit}
end
